...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  try {
    ...
    switch (name) {
      ...
      case "get_website": result = await client.getWebsite(args?.id as number); break;
      case "update_website": result = await client.updateWebsite(args?.site); break;
      case "delete_website": result = await client.deleteWebsite(args?.id as number); break;
      // Website Domains
      case "list_website_domains": result = await client.listWebsiteDomains(args?.websiteId as number); break;
      case "create_website_domain": result = await client.createWebsiteDomain(args); break;
      case "delete_website_domain": result = await client.deleteWebsiteDomain(args); break;
      case "update_website_domain": result = await client.updateWebsiteDomain(args); break;
      // SSL Certificates
      case "list_certificates": result = await client.listCertificates(); break;
      case "get_certificate": result = await client.getCertificate(args?.id as number); break;
      ...
      case "obtain_ssl": result = await client.obtainSSL(args); break;
      case "renew_ssl": result = await client.renewSSL(args); break;
      case "resolve_ssl": result = await client.resolveSSL(args); break;
      case "upload_ssl": result = await client.uploadSSL(args); break;
      case "get_website_ssl": result = await client.getWebsiteSSL(args?.websiteId as number); break;
      // HTTPS
      case "get_https": result = await client.getHTTPS(args?.id as number); break;
      case "update_https": result = await client.updateHTTPS(args); break;
      case "apply_ssl": result = await client.applySSL(args); break;
      // Nginx
      case "get_nginx_conf": result = await client.getNginxConf(args?.id as number); break;
      case "update_nginx_conf": result = await client.updateNginxConf(args); break;
      // Databases - Basic
      ...
      case "get_database": result = await client.getDatabase(args?.type as string, args?.id as number); break;
      // Databases - MySQL
      case "mysql_bind_user": result = await client.mysqlBindUser(args); break;
      case "mysql_change_password": result = await client.mysqlChangePassword(args); break;
      case "mysql_change_access": result = await client.mysqlChangeAccess(args); break;
      case "mysql_get_info": result = await client.mysqlGetInfo(args?.from as "local" | "remote"); break;
      case "mysql_get_remote_access": result = await client.mysqlGetRemoteAccess(); break;
      case "mysql_update_remote_access": result = await client.mysqlUpdateRemoteAccess(args?.privilege as boolean); break;
      case "mysql_get_status": result = await client.mysqlGetStatus(); break;
      case "mysql_get_variables": result = await client.mysqlGetVariables(); break;
      case "mysql_update_variables": result = await client.mysqlUpdateVariables(args?.variables as Record<string, string>); break;
      // Databases - PostgreSQL
      case "postgresql_bind_user": result = await client.postgresqlBindUser(args); break;
      case "postgresql_change_password": result = await client.postgresqlChangePassword(args); break;
      case "postgresql_change_privileges": result = await client.postgresqlChangePrivileges(args); break;
      case "postgresql_list_databases": result = await client.postgresqlListDatabases(); break;
      // Databases - Redis
      case "redis_get_conf": result = await client.redisGetConf(args?.id as number); break;
      case "redis_update_conf": result = await client.redisUpdateConf(args); break;
      case "redis_change_password": result = await client.redisChangePassword(args); break;
      case "redis_get_status": result = await client.redisGetStatus(); break;
      case "redis_get_persistence_conf": result = await client.redisGetPersistenceConf(args?.id as number); break;
      case "redis_update_persistence_conf": result = await client.redisUpdatePersistenceConf(args?.id as number, args); break;
      // System
      ...
      // Backup Account
      case "list_backup_accounts": result = await client.listBackupAccounts(); break;
      case "get_backup_account_options": result = await client.getBackupAccountOptions(); break;
      case "get_backup_account_client_info": result = await client.getBackupAccountClientInfo(args?.clientType as string); break;
      case "create_backup_account": result = await client.createBackupAccount(args); break;
      case "update_backup_account": result = await client.updateBackupAccount(args); break;
      case "delete_backup_account": result = await client.deleteBackupAccount(args); break;
      case "check_backup_account": result = await client.checkBackupAccount(args); break;
      case "list_backup_account_files": result = await client.listBackupAccountFiles(args?.backupAccountID as number, args?.path as string); break;
      // Settings
      ...
      // Fail2ban
      case "get_fail2ban_base_info": result = await client.getFail2BanBaseInfo(); break;
      case "get_fail2ban_conf": result = await client.getFail2BanConf(); break;
      case "operate_fail2ban": result = await client.operateFail2Ban(args); break;
      case "operate_fail2ban_ssh": result = await client.operateFail2BanSSH(args); break;
      case "search_fail2ban_banned_ips": result = await client.searchFail2BanBannedIPs(args); break;
      case "update_fail2ban_conf": result = await client.updateFail2BanConf(args); break;
      case "update_fail2ban_conf_by_file": result = await client.updateFail2BanConfByFile(args?.content as string); break;
      // Disk
      case "list_disks": result = await client.listDisks(); break;
      case "get_disk_full_info": result = await client.getDiskFullInfo(); break;
      case "mount_disk": result = await client.mountDisk(args); break;
      case "partition_disk": result = await client.partitionDisk(args); break;
      case "unmount_disk": result = await client.unmountDisk(args?.mountPoint as string); break;
      // Dashboard
      case "get_dashboard_base_info": result = await client.getDashboardBaseInfo(); break;
      case "get_dashboard_current_info": result = await client.getDashboardCurrentInfo(); break;
      case "get_dashboard_memo": result = await client.getDashboardMemo(); break;
      case "update_dashboard_memo": result = await client.updateDashboardMemo(args?.content as string); break;
      // Monitor
      case "get_monitor_data": result = await client.getMonitorData(args); break;
      case "get_monitor_setting": result = await client.getMonitorSetting(); break;
      case "update_monitor_setting": result = await client.updateMonitorSetting(args?.setting); break;
      case "clean_monitor_data": result = await client.cleanMonitorData(); break;
      // Device
      case "get_device_base_info": result = await client.getDeviceBaseInfo(); break;
      case "check_device_dns": result = await client.checkDeviceDNS(); break;
      case "update_device": result = await client.updateDevice(args?.conf); break;
      case "update_device_by_file": result = await client.updateDeviceByFile(args?.content as string); break;
      case "update_device_hosts": result = await client.updateDeviceHosts(args?.hosts as string); break;
      case "update_device_password": result = await client.updateDevicePassword(args?.oldPass as string, args?.newPass as string); break;
      case "update_device_swap": result = await client.updateDeviceSwap(args?.swap); break;
