...
export class OnePanelClient {
  ...
  // Containers
  async listContainers(): Promise<any> { return this.request("/api/v2/containers/search"); }
  ...
  // Networks
  async listNetworks(): Promise<any> { return this.request("/api/v2/containers/network"); }
  ...
  // Volumes
  async listVolumes(): Promise<any> { return this.request("/api/v2/containers/volume"); }
  ...
  // Compose
  async listComposes(): Promise<any> { return this.request("/api/v2/containers/compose/search"); }
  ...
  // Apps
  async listInstalledApps(): Promise<any> { return this.request("/api/v2/apps/installed/search"); }
  async listAppStore(): Promise<any> { return this.request("/api/v2/apps/search"); }
  ...
  // Files
  async listFiles(path: string): Promise<any> { return this.request(`/api/v2/files?path=${encodeURIComponent(path)}`); }
  async getFileContent(path: string): Promise<any> { return this.request(`/api/v2/files/content?path=${encodeURIComponent(path)}`); }
  ...
  // Websites
  async listWebsites(): Promise<any> { return this.request("/api/v2/websites/search"); }
  ...
  // Certificates
  async listCertificates(): Promise<any> { return this.request("/api/v2/websites/ssl/search"); }
  ...
  // Databases
  async listDatabases(type: string): Promise<any> { return this.request(`/api/v2/databases/${type}/search`); }
  ...
  // Cronjobs
  async listCronjobs(): Promise<any> { return this.request("/api/v2/cronjobs/search"); }
